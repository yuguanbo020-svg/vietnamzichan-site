...
"hung-yen-industrial-parks-expansion-2026":{
"vi":["Theo Vietnam Investment Review (VIR), sản xuất công nghiệp của tỉnh Hưng Yên trong 7 tháng đầu năm 2026 tăng 15,4% so với cùng kỳ, trong đó ngành chế biến, chế tạo tăng 16,05%.","Báo cáo cho biết tỉnh Hưng Yên đã thành lập mới ba khu công nghiệp Tân Dân, số 08 và số 10, đồng thời bổ sung thêm bốn cụm công nghiệp.","Báo cáo cho biết tính đến ngày 31 tháng 7 năm 2026, tỉnh Hưng Yên có lũy kế 975 dự án đầu tư nước ngoài với tổng vốn đăng ký 18,8 tỷ USD; và 3.230 dự án đầu tư trong nước với tổng vốn đăng ký 33,2 tỷ USD.","Báo cáo cho biết một khu công nghệ cao đang được quy hoạch tại Hưng Yên có diện tích gần 500 ha, gồm tám phân khu chức năng, với vốn đầu tư dự kiến khoảng 400 triệu USD."],
"en":["Vietnam Investment Review (VIR) reported that Hung Yen province's industrial production grew 15.4% year-on-year in the first seven months of 2026, with manufacturing and processing up 16.05%.","The report said Hung Yen newly established three industrial parks \u2014 Tan Dan, No. 08 and No. 10 \u2014 and added four new industrial clusters.","The report said that as of 31 July 2026, Hung Yen had 975 cumulative foreign-invested projects with total registered capital of US$18.8 billion, and 3,230 domestic investment projects with total registered capital of US$33.2 billion.","The report said a planned high-tech park in Hung Yen covers nearly 500 hectares with eight functional zones, with an estimated investment of about US$400 million."]}}
